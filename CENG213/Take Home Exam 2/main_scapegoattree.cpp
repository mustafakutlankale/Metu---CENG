...
//    try { std::cout << "Line no:" << 54 << " " << a->getMin() << std::endl; }
//    catch (NoSuchItemException a) { ; }
//    try { std::cout << "Line no:" << 55 << " " << a->getMax() << std::endl; }
//    catch (NoSuchItemException a) { ; }
//    try { std::cout << "Line no:" << 56 << " " << a->getFloor(423) << std::endl; }
//    catch (NoSuchItemException a) { ; }
//    try { std::cout << "Line no:" << 57 << " " << a->getCeiling(423) << std::endl; }
//    catch (NoSuchItemException a) { ; }
//    try { std::cout << "Line no:" << 58 << " " << a->getNext(423) << std::endl; }
//    catch (NoSuchItemException a) { ; }
//    try { std::cout << "Line no:" << 59 << " " << a->get(423) << std::endl; }
//    catch (NoSuchItemException a) { ; }
//    try { std::cout << "Line no:" << 60 << " " << a->getHeight() << std::endl; }
//    catch (NoSuchItemException a) { ; }
//    try { std::cout << "Line no:" << 61 << " " << a->getSize() << std::endl; }
//    catch (NoSuchItemException a) { ; }
...
//    *b = *b;
//    try { std::cout << "Line no:" << 113 << " " << a->getMin() << std::endl; }
//    catch (NoSuchItemException a) { ; }
//    try { std::cout << "Line no:" << 114 << " " << a->getMax() << std::endl; }
//    catch (NoSuchItemException a) { ; }
//    try { std::cout << "Line no:" << 115 << " " << a->getFloor(171) << std::endl; }
//    catch (NoSuchItemException a) { ; }
//    try { std::cout << "Line no:" << 116 << " " << a->getCeiling(171) << std::endl; }
//    catch (NoSuchItemException a) { ; }
//    try { std::cout << "Line no:" << 117 << " " << a->getNext(171) << std::endl; }
//    catch (NoSuchItemException a) { ; }
//    try { std::cout << "Line no:" << 118 << " " << a->get(171) << std::endl; }
//    catch (NoSuchItemException a) { ; }
//    try { std::cout << "Line no:" << 119 << " " << a->getHeight() << std::endl; }
//    catch (NoSuchItemException a) { ; }
//    try { std::cout << "Line no:" << 120 << " " << a->getSize() << std::endl; }
//    catch (NoSuchItemException a) { ; }
...
//    try { std::cout << "Line no:" << 171 << " " << a->getMin() << std::endl; }
//    catch (NoSuchItemException a) { ; }
//    try { std::cout << "Line no:" << 172 << " " << a->getMax() << std::endl; }
//    catch (NoSuchItemException a) { ; }
//    try { std::cout << "Line no:" << 173 << " " << a->getFloor(420) << std::endl; }
//    catch (NoSuchItemException a) { ; }
//    try { std::cout << "Line no:" << 174 << " " << a->getCeiling(420) << std::endl; }
//    catch (NoSuchItemException a) { ; }
//    try { std::cout << "Line no:" << 175 << " " << a->getNext(420) << std::endl; }
//    catch (NoSuchItemException a) { ; }
//    try { std::cout << "Line no:" << 176 << " " << a->get(420) << std::endl; }
//    catch (NoSuchItemException a) { ; }
//    try { std::cout << "Line no:" << 177 << " " << a->getHeight() << std::endl; }
//    catch (NoSuchItemException a) { ; }
//    try { std::cout << "Line no:" << 178 << " " << a->getSize() << std::endl; }
//    catch (NoSuchItemException a) { ; }
...
//    try { std::cout << "Line no:" << 229 << " " << a->getMin() << std::endl; }
//    catch (NoSuchItemException a) { ; }
//    try { std::cout << "Line no:" << 230 << " " << a->getMax() << std::endl; }
//    catch (NoSuchItemException a) { ; }
//    try { std::cout << "Line no:" << 231 << " " << a->getFloor(179) << std::endl; }
//    catch (NoSuchItemException a) { ; }
//    try { std::cout << "Line no:" << 232 << " " << a->getCeiling(179) << std::endl; }
//    catch (NoSuchItemException a) { ; }
//    try { std::cout << "Line no:" << 233 << " " << a->getNext(179) << std::endl; }
//    catch (NoSuchItemException a) { ; }
//    try { std::cout << "Line no:" << 234 << " " << a->get(179) << std::endl; }
//    catch (NoSuchItemException a) { ; }
//    try { std::cout << "Line no:" << 235 << " " << a->getHeight() << std::endl; }
//    catch (NoSuchItemException a) { ; }
//    try { std::cout << "Line no:" << 236 << " " << a->getSize() << std::endl; }
//    catch (NoSuchItemException a) { ; }
//    a->printPretty();
//    a->print(preorder);
//    a->print(inorder);
